...
const token = core_1.default.getInput("github-token", { required: true }), context = github_1.default.context, owner = context.repo.owner, repo = context.repo.repo, client = new github_1.default.GitHub(token), ms = core_1.default.getInput("milliseconds");
function run() {
